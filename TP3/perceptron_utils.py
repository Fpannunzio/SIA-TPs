...
#
#
# def _get_multi_layered_perceptron(l_rate: float, input_count: int, params: Param) -> Perceptron:
...
#     real_activation_derivative: ActivationFunction = lambda x: activation_derivative(x, params['slope_factor'])
#
#     return MultilayeredPerceptron(l_rate, input_count, real_activation_function, real_activation_derivative,
#                                   params['layer_sizes'])
#
#
